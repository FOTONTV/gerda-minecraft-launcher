import type { ResolvedLibrary, Version } from '@gmcl/core'
import type { InstallProfile, LiteloaderVersion, MinecraftVersion, QuiltArtifactVersion } from '@gmcl/installer'
