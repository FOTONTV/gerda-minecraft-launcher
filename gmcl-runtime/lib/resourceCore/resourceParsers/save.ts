import { ResourceDomain, ResourceSaveMetadata, ResourceType } from '@gmcl/runtime-api'
import type { IResourceParser } from './index'
import { findLevelRootDirectory, readResourceSaveMetadata } from '../../entities/save'
