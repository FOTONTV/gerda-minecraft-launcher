import { createMinecraftProcessWatcher, diagnoseJar, diagnoseLibraries, generateArguments, launch, LaunchOption, LaunchPrecheck, MinecraftFolder, ResolvedVersion, Version } from '@gmcl/core'
import { LaunchException, LaunchOptions, LaunchService as ILaunchService, LaunchServiceKey, LaunchState } from '@gmcl/runtime-api'
  ...
  async launch(options?: LaunchOptions) {
    try {
      ...
      const option: LaunchOption = {
        ...
        launcherName: options?.launcherName ?? 'gmcl',
        yggdrasilAgent,
        prechecks,
      }
