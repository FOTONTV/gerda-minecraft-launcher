import { DiagnoseService as IDiagnoseService, DiagnoseServiceException, DiagnoseServiceKey, DiagnoseState, Issue, IssueKey, IssueReport, IssueReportBuilder } from '@gmcl/runtime-api'
