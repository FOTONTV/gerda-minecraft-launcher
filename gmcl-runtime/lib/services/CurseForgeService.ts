import { File, FileModLoaderType, FileRelationType, SearchOptions } from '@gmcl/curseforge'
import { DownloadTask } from '@gmcl/installer'
import { CurseForgeService as ICurseForgeService, CurseForgeServiceKey, getCurseforgeFileUri, GetModFilesOptions, InstallFileOptions, InstallFileResult, ProjectType, ResourceDomain } from '@gmcl/runtime-api'
...
export class CurseForgeService extends AbstractService implements ICurseForgeService {
  ...
  constructor(@Inject(LauncherAppKey) app: LauncherApp,
    ...
    this.client = new CurseforgeClient('$2a$10$t/0Pa1v6wP.SoM0Q/0BjKubrd5.3j4ZoA1k4pBjZyIli7TOyEYOvm', dispatcher)
  }
