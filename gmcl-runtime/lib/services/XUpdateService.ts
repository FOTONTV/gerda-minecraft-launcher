import { checksum } from '@gmcl/core'
import { InstanceFile, InstanceIOException, InstanceManifest, InstanceUpdate, SetInstanceManifestOptions, XUpdateService as IXUpdateService, XUpdateServiceKey } from '@gmcl/runtime-api'
