import { createSsdp, UpnpClient, UpnpMapOptions, UpnpUnmapOptions } from '@gmcl/nat-api'
import { NatService as INatService, NatServiceKey, NatState } from '@gmcl/runtime-api'
