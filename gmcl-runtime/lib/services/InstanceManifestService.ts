import { GetManifestOptions, InstanceFile, InstanceManifest, InstanceManifestService as IInstanceManifestService, InstanceManifestServiceKey, Resource, ResourceDomain } from '@gmcl/runtime-api'
