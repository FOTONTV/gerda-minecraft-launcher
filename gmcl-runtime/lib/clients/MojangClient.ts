import { MicrosoftMinecraftProfile, NameAvailability, NameChangeInformation } from '@gmcl/runtime-api'
import { MojangChallenge, MojangChallengeResponse } from '@gmcl/user'
