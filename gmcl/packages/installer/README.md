...
[![npm version](https://img.shields.io/npm/v/@gmcl/installer.svg)](https://www.npmjs.com/package/@gmcl/installer)
[![Downloads](https://img.shields.io/npm/dm/@gmcl/installer.svg)](https://npmjs.com/@gmcl/installer)
[![Install size](https://packagephobia.now.sh/badge?p=@gmcl/installer)](https://packagephobia.now.sh/result?p=@gmcl/installer)
...
```ts
    import { getVersionList, MinecraftVersion, install } from "@gmcl/installer";
    import { MinecraftLocation } from "@gmcl/core";
...
```ts
    import { installLibraries } from "@gmcl/installer";
    import { ResolvedVersion, MinecraftLocation, Version } from "@gmcl/core";
...
```ts
    import { installAssets } from "@gmcl/installer";
    import { MinecraftLocation, ResolvedVersion, Version } from "@gmcl/core";
...
```ts
    import { installDependencies } from "@gmcl/installer";
    import { MinecraftLocation, ResolvedVersion, Version } from "@gmcl/core";
...
```ts
    import { installForge, getForgeVersionList, ForgeVersionList, ForgeVersion } from "@gmcl/installer";
    import { MinecraftLocation } from "@gmcl/core";
...
```ts
    import { installForge } from "@gmcl/installer";
...
```ts
    import { installFabric, FabricArtifactVersion } from "@gmcl/installer";
...
```ts
    import { installJreFromMojang } from "@gmcl/installer";
