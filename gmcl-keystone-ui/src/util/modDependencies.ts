import { ForgeModMetadata } from '@gmcl/mod-parser'
import { FabricResource, ForgeResource, isFabricResource, isForgeResource, Resource } from '@gmcl/runtime-api/src/entities/resource'
