...
import { Mod } from '@gmcl/curseforge'
import { Project, SearchResultHit } from '@gmcl/modrinth'
import { Resource, ResourceDomain, ResourceServiceKey } from '@gmcl/runtime-api'
