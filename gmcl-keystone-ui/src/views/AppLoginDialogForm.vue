    ...
    >
      ...
      <div class="mt-4">
        <a
          ...
          href="https://www.minecraft.net/ru-ru/forgot-password"
        >{{
          t("login.forgetPassword")
        }}</a>
        <a
          style="z-index: 20"
          href="https://www.minecraft.net/ru-ru/login?return_url=/ru-ru/profile"
        >
...
import { Ref } from 'vue'
import { isException, OfficialUserServiceKey, UserException, UserServiceKey } from '@gmcl/runtime-api'
