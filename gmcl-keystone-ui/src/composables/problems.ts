import { Ref } from 'vue'
import { AssetIndexIssueKey, AssetsIssueKey, IncompatibleJavaIssueKey, InstallProfileIssueKey, InvalidJavaIssueKey, isIssue, Issue, LibrariesIssueKey, MissingAuthLibInjectorIssue, MissingJavaIssueKey, VersionIssueKey, VersionJarIssueKey, VersionJsonIssueKey } from '@gmcl/runtime-api'
