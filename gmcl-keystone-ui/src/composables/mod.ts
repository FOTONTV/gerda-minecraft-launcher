...
import { InstanceJavaServiceKey, InstanceModsServiceKey, InstanceServiceKey, isModResource, isPersistedResource, Resource, ResourceServiceKey } from '@gmcl/runtime-api'
...
export function useInstanceMods() {
  ...
  function updateItems() {
    ...
    enabledModCounts.value = newItems.filter(v => 
      !v.path.endsWith('.disabled')).length
  }
